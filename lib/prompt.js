...
export function buildTwoPersonPrompt(look, bird) {
  return [
    "Create a completely new, original studio photograph of the SAME person shown in the two reference photos — painted from scratch, NOT assembled or composited from them.",
    "Do NOT cut out, crop, copy, or paste any pixels from the reference photos. Re-draw and re-light the ENTIRE image — including the face and head — as one seamless photograph: the face must take on the NEW studio lighting, not keep the lighting from the original photos. No collage, no pasted-on head, no mismatched edges or skin tone between head and body.",
    "Use the references only to capture identity — face shape, features, skin tone, eye colour, beard/facial hair, and hair (length and any baldness or thinning). It must be recognisably the same person, with the same gender and age; do not beautify or slim them.",

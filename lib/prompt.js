...
export function buildTwoPersonPrompt(look, bird) {
  return [
    ...
    "Even if the requested outfit happens to resemble clothing the person is already wearing in a reference photo, do NOT reuse that photo — still produce a distinctly NEW studio portrait with a different pose, camera angle, framing, lighting and background.",
    "Keep their facial identity exact and unmistakable — same face shape, eye colour, skin tone, apparent age, and facial hair.",
    "Reproduce their real hair faithfully: the SAME hairline, hair length and amount, including any baldness, receding, or thinning. NEVER add, restore, thicken, or lengthen hair they do not have.",
    "Keep skin realistic with natural texture — do NOT airbrush, over-smooth, beautify, or slim the face. They should look like themselves on a good day, not an idealized model.",

...
// Edit prompt for /api/birdify: takes a FINISHED clean headshot + the bird's
// reference image and paints the bird INTO the scene (behind at true scale for
// huge species, perched on the shoulder otherwise) without touching the person.
// This is what makes the "you + your bird" keepsake photoreal — a flat cutout
// paste-on was tried first (2026-07-04) and looked exactly as bad as you'd think.

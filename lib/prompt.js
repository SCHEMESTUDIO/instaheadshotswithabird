...
export function buildTwoPersonPrompt(look, bird) {
  return [
    "You are given two reference photos of the SAME person — use both to capture their exact likeness.",
    "Create a polished, professional studio headshot that is unmistakably this same person: keep their facial features, face shape, skin tone, eye colour, beard/facial hair, and hair (including length and any baldness or thinning) matching the references. Do not change their gender, age, or identity, and do not beautify or slim them.",
